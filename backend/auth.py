...
ROLE_PERMISSIONS = {
    "system_admin": {"settings:read", "settings:manage", "users:manage", "audit:read",
                     ...
                     "receipts:manage", "accounting:read", "recon:read", "budget:read",
                     "ops:read", "ads:review", "ads:publish", "documents:read"},
    ...
    "coordinator": {"ops:read", "ops:manage", "ads:review", "ads:publish",
