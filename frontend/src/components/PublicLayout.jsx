...
import { FootfallMeter, FootfallWelcomeCard, FootfallMilestoneBanner, FootfallTopBar } from "./Footfall";
...
export function PublicNav() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      <FootfallTopBar />
      <div className="border-b border-sun-400/25 bg-white/85 backdrop-blur-xl">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/transparency" className="hover:text-brown-900">Digital Pandal Meter</Link></li>
...
export default function PublicLayout({ children }) {
  return (
    <div className="min-h-screen bg-sky-50 font-body text-brown-900">
      ...
      <main className="pt-[6.75rem] sm:pt-[7.5rem]">{children}</main>
      <FootfallMeter variant="floating" />
      <FootfallWelcomeCard />
      <PublicFooter />
    </div>
  );
