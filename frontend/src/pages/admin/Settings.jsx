...
function ChangePassword() {
  ...
  return (
    <Card data-testid="change-password-card">
      <CardBody>
        <h3 className="mb-1 flex items-center gap-2 font-display text-xl">
          <Lock className="h-5 w-5 text-vermilion-500" /> Change my password
        </h3>
        <p className="mb-4 text-sm text-brown-800/55">
          Updates the password for your signed-in committee account only.
        </p>
        <form onSubmit={submit} className="grid max-w-md gap-3">
          ...
          <div>
            <Button variant="admin" type="submit" disabled={busy} data-testid="pw-save-btn">
